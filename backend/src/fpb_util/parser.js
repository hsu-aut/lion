...
// 	const jsonFilePath = uploadDir + '/' + jsonFileName;
// 	const rdfFilePath = rdfDir + '/' + jsonFileName.replace('.json', '.ttl');

// 	try {
// 		if (fs.existsSync(rdfFilePath)) {
// 			const ttlFile = fs.readFileSync(rdfFilePath);
// 			return ttlFile.toString();
// 		} else {

// 			const fpbjsFile = fs.readFileSync(jsonFilePath);
// 			const fpbjs = JSON.parse(fpbjsFile);

// 			const processRDF = rdf.mapJsonToRDF(fpbjs);
