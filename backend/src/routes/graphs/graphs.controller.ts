...
export class GraphsController {
	...
	getTriplesOfNamedGraph(@Query('graph') graph: string, @Headers('accept') format: string): void {
		console.log(format);
		this.graphService.getAllTriples(decodeURIComponent(graph), format).subscribe((data) => console.log(data.data));
	}
